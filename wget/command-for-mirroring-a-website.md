...
Specifying empty user agent with `--user-agent=""` instructs Wget not to send the User-Agent header in HTTP requests. See [here](https://en.wikipedia.org/wiki/User_agent) for more information.
